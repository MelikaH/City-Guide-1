...
export class FoodComponent implements OnInit , AfterViewChecked {
  found_places: any[] = [];
  information: any;
  @Input() city: City;
    ...
    this.ngZone.runOutsideAngular(() => {
      this._mineRadarSearch(this, () => {
        this.ngZone.run( () => {
          ...
          if(this.found_places.length==0) this.information="No restaurants found!";
          else {
            this.information="Found "+this.found_places.length+" restaurants, cafes and bars!";
          }
        });
      });
    });
